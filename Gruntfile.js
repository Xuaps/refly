...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      app: {
        files: [
          { expand: true, src: ['app/**', 'public/**', 'routes/**', 'app.js', 'views/**', 'package.json', '!public/css/styles.css', '!public/css/treeview.css', '!public/css/sidebar.css', '!public/css/welcome.css', '!public/css/settings.css', '!public/css/devdocs.css'], dest: 'build/release/'},
    ...
    cssmin:{
        target: {
            files: {
                'public/css/refly.css': ['public/css/styles.css', 'public/css/treeview.css', 'public/css/sidebar.css', 'public/css/welcome.css', 'public/css/settings.css', 'public/css/devdocs.css']
                }
         }
    }
  });
